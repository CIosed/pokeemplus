...
static const u8 sTileBitAttributes[] =
{
    ...
    [MB_MIRAGE_TOWER] = TILE_ATTRIBUTES(TRUE, FALSE, TRUE),
...
{
    if (metatileBehavior == MB_TALL_GRASS || metatileBehavior == MB_LONG_GRASS || metatileBehavior == MB_TALL_SOOT_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsCuttableGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_TALL_GRASS
	 ...
	 || metatileBehavior == MB_TALL_SOOT_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsMtChimneyOutside(u8 metatileBehavior)
{
    if (metatileBehavior == MB_MT_CHIMNEY_OUTSIDE)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsSootGround(u8 metatileBehavior)
{
    if (metatileBehavior == MB_SOOT_GROUND)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsJaggedPass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_JAGGED_PASS)
        return TRUE;
    else
        return FALSE;
}

bool8 MetatileBehavior_IsJaggedPassTallGrass(u8 metatileBehavior)
{
    if (metatileBehavior == MB_JAGGED_PASS_TALL_GRASS)
        return TRUE;
    else
        return FALSE;
}
...
bool8 MetatileBehavior_IsMirageTower(u8 metatileBehavior)
{
    if (metatileBehavior == MB_MIRAGE_TOWER)
        return TRUE;
    else
        return FALSE;
}
