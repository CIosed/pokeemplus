...
static const struct BattleBackground gBattleTerrainTable[] =
{
    ...
    [BATTLE_TERRAIN_RUSTURF] =
    {
        .tileset = gBattleTerrainTiles_Rusturf,
        .tilemap = gBattleTerrainTilemap_Rusturf,
        .entryTileset = gBattleTerrainAnimTiles_Rusturf,
    ...
    [BATTLE_TERRAIN_TALL_SOOT_GRASS] =
    {
        .tileset = gBattleTerrainTiles_TallSootGrass,
        .tilemap = gBattleTerrainTilemap_TallSootGrass,
        .entryTileset = gBattleTerrainAnimTiles_TallSootGrass,
        .entryTilemap = gBattleTerrainAnimTilemap_TallSootGrass,
        .palette = gBattleTerrainPalette_TallSootGrass,
    },

    [BATTLE_TERRAIN_SOOT_GROUND] =
    {
        .tileset = gBattleTerrainTiles_SootGround,
        .tilemap = gBattleTerrainTilemap_SootGround,
        .entryTileset = gBattleTerrainAnimTiles_SootGround,
    ...
    [BATTLE_TERRAIN_METEOR_FALLS] =
    {
        .tileset = gBattleTerrainTiles_MeteorFalls,
        .tilemap = gBattleTerrainTilemap_MeteorFalls,
        .entryTileset = gBattleTerrainAnimTiles_MeteorFalls,
        .entryTilemap = gBattleTerrainAnimTilemap_MeteorFalls,
    ...
    [BATTLE_TERRAIN_JAGGED_PASS_TALL_GRASS] =
    {
        .tileset = gBattleTerrainTiles_JaggedPass,
        .tilemap = gBattleTerrainTilemap_JaggedPass,
        .palette = gBattleTerrainPalette_JaggedPass,
