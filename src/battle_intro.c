...
static const TaskFunc sBattleIntroSlideFuncs[] =
{
    ...
    BattleIntroSlide1, // BATTLE_TERRAIN_RUSTURF
    BattleIntroSlide1, // BATTLE_TERRAIN_MT_CHIMNEY_OUTSIDE
    BattleIntroSlide1, // BATTLE_TERRAIN_MT_CHIMNEY_INSIDE
    BattleIntroSlide1, // BATTLE_TERRAIN_TALL_SOOT_GRASS
    BattleIntroSlide1, // BATTLE_TERRAIN_SOOT_GROUND
    BattleIntroSlide3, // BATTLE_TERRAIN_FIELD
    BattleIntroSlide1, // BATTLE_TERRAIN_METEOR_FALLS
    BattleIntroSlide1, // BATTLE_TERRAIN_JAGGED_PASS
    BattleIntroSlide3, // BATTLE_TERRAIN_JAGGED_PASS_TALL_GRASS
    BattleIntroSlide3, // BATTLE_TERRAIN_LAB
    BattleIntroSlide3, // BATTLE_TERRAIN_MT_PYRE
    BattleIntroSlide1, // BATTLE_TERRAIN_MIRAGE_TOWER
};
